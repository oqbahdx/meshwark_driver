    ...
    return Scaffold(
      ...
      body: BlocConsumer<TripHistoryCubit, TripHistoryState>(
        ...
        builder: (context, state) {
          ...
          if (cubit.tripList?.isEmpty == true) {
            ...
            return RefreshIndicator(
              ...
              child: ListView.builder(
                itemCount: cubit.tripList?.length ?? 0,
                padding: EdgeInsets.symmetric(vertical: 8.h, horizontal: 16.w),
                itemBuilder: (context, index) {
                  final trip = cubit.tripList?[index];
                  return Card(
                    elevation: 0,
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                SizedBox(width: 4.w),
                                Text(
                                  "${trip?.date != null ? DateFormat('MMM d, yyyy').format(trip!.date!) : 'Unknown'} ${trip?.time ?? 'Unknown'}",
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            AppStrings.noTripHistoryAvailable.tr(),
            style: getBoldStyle(
              color: ColorManager.primary,
