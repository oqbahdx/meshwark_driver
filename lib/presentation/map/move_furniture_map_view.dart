...
class MoveFurnitureMapView extends StatefulWidget {
  const MoveFurnitureMapView({super.key});

  @override
  State<MoveFurnitureMapView> createState() => _MoveFurnitureMapViewState();
}

class _MoveFurnitureMapViewState extends State<MoveFurnitureMapView> {
 ...
 Timer? _timer;
  ...
  void initState() {
    super.initState();
    context.read<MoveMapCubit>().initializeNotification();
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<MoveMapCubit, MoveMapState>(
      listener: (context, state) {},
      builder: (context, state) {
        var cubit = context.read<MoveMapCubit>();
        return Scaffold(
            ...
            title: cubit.isMoveFurnitureActive
                ? BuildElevatedButton(
                    ...
                    onTap: () {
                      ...
                      cubit.endMoveFurnitureTrip();
                      cubit.showNotification(id: 3,
                          title: AppStrings.end.tr(), body: AppStrings.offlineMessage.tr());
                ...
                : BuildElevatedButton(
                    ...
                    onTap: () {
                      ...
                      cubit.startMoveFurnitureTrip();
                      cubit.showNotification(id: 4, title: AppStrings.start.tr(), body: AppStrings.onlineMessage.tr());
                      Fluttertoast.showToast(
